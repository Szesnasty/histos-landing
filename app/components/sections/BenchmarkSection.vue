  ...
  <section id="sweep" class="page-section benchmark">
    <div class="page-container">
      ...
      <p class="section-lede prose-column">
        ...
        the hash of the policy that decided — are at <a href="/sweep.jsonl" download>sweep.jsonl</a>.
      </p>
      ...
      <details class="benchmark__method">
        ...
        <p>
          Raw per-run records: <a href="/sweep.jsonl" download>sweep.jsonl</a>. Re-run any cell with
